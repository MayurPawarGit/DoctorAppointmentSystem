...
<html lang="en">
	...
	<body>
		...
		<nav class="navbar navbar-default " role="navigation">
			<div class="container-fluid">
				...
				<div class="navbar-header">
					...
					<a class="navbar-brand" href="patient.php"><img alt="Brand" src="assets/img/suyashddd.png" height="40px"></a>
				</div>
		...
		<div class="copyright-bar bg-black">
			<div class="container">
				<p class="pull-left small">© Develop By Mayur & Khushal</p>
				<p class="pull-right small">All Rights Reserved</p>
			</div>
		</div>
		<!-- footer end -->
